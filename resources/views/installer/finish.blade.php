...
@section('content')
    <div class="py-4 text-center">
        <div class="mb-6">
            ...
            <p class="mb-6 text-gray-600">{{ config('app.name') }} is now ready to use. You can now access your application.</p>
        ...
        <div class="mt-6">
            <a href="{{ $appUrl }}" class="inline-flex items-center px-6 py-3 text-lg font-medium text-white rounded btn-primary">
