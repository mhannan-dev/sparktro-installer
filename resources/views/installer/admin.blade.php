...
@section('content')
    ...
    <form action="{{ route('install.admin.store') }}" method="post" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" id="name" name="name" placeholder="Full Name" class="p-3 w-full rounded form-input"
                required>
        ...
        <div>
            ...
            <input type="email" id="email" name="email" placeholder="Email" class="p-3 w-full rounded form-input"
                required>
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                <input type="password" id="password_confirmation" name="password_confirmation"
                    placeholder="Confirm Password" class="p-3 w-full rounded form-input" required>
            </div>
        </div>
