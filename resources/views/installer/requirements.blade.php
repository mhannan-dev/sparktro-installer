...
@section('content')
<h2 class="mb-4 text-xl font-semibold">System Requirements</h2>
<ul class="mb-6">
...
<form action="{{ route('install.database') }}" method="post" class="space-y-4">
    ...
    <input type="text" name="db_host" placeholder="DB Host" class="p-2 w-full border" value="127.0.0.1" required>
    <input type="text" name="db_port" placeholder="DB Port" value="3306" class="p-2 w-full border" required>
    <input type="text" name="db_name" placeholder="Database Name" class="p-2 w-full border" required value="relief_hub_pro">
    <input type="text" name="db_user" placeholder="Database User" class="p-2 w-full border" required value="root">
    <input type="password" name="db_pass" placeholder="Database Password" class="p-2 w-full border" value="11111111">
    <button type="submit" class="px-4 py-2 text-white bg-blue-600 rounded">Next</button>
</form>
@endsection --}}
